...
extension ContentView_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        __designTimeSelection(ContentView(), "#8344.[2].[0].property.[0].[0]")
    #sourceLocation()
    }
}
...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        __designTimeSelection(Text(__designTimeString("#8344.[1].[0].property.[0].[0].arg[0].value", fallback: "Hello, Dohyung!"))
            .padding(), "#8344.[1].[0].property.[0].[0]")
    #sourceLocation()
    }
}
